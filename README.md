...
Areada supports EPUB, PDF, TXT, and FB2 files, with a clean monochrome interface, local library access, saved reading progress, bookmarks, search, filters, and basic plain-text note support.
...
- **Local reading:** EPUB, PDF, TXT, and FB2 support with saved reading progress
- **Bookmarks:** Persistent local bookmarks for supported reading files
- **Recent reading:** Quickly resume files from the Reading section
...
- **Reader controls:** Theme, font family, font size, and pinch-to-zoom support where available
- **Notes:** Create and edit basic local `.txt` notes for simple note keeping
- **Note safety:** Plain-text timestamps, undo/redo, autosave behavior, and discard confirmation for editable TXT notes
...
Areada does not include ads, analytics, tracking, accounts, cloud sync, or external services.
